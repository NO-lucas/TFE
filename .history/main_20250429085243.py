...
from lora import run_uni, run_uni_lora, run_uni_lora_percent, run_process_wsi, pipeline, run_lora-optuna
...
def main():
    ...
    # Percentage - LoRA experiment
        ...
        def objective(trial):
            ...
            # Charger les données avec la nouvelle taille de batch
            train_loader, val_loader, test_loader = get_data_loaders(args)

            # Entraîner le modèle
            val_acc = run_lora_optuna(args, clip_model, logit_scale, train_loader, val_loader, test_loader)
